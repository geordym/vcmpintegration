...
public class ServerImpl implements Server {
    ...
    public void sendClientMessage(Player recipient, Colour colour, String message) {
        sendClientMessage(recipient, colour == null ? 0xFF67A2D8 : colour.getHex(), message);
    }

    @Override
    public void sendGameMessageToAll(int type, String message) {
        sendGameMessage(null, type, message);
    }

    @Override
    public void sendClientMessageToAll(Colour colour, String message) {
        sendClientMessage(null, colour == null ? 0xFF67A2D8 : colour.getHex(), message);
    }

    @Override
    public void sendClientMessageToAll(String message) {
        sendClientMessageToAll(null, message);
    }
