...
public interface Player extends Entity {
    ...
    /*
    void panCameraSmoothly(float posX, float posY, float posZ, int transitionMs);

    void panCameraSmoothly(Vector vec, int transitionMs);
    ...
    void setDrunkHandling(int level);

    int getDrunkVisuals();

    void setDrunkVisuals(int level);
     */
    ...
    //float getNetworkStatistics(NetworkStatisticOption option);
}
