...
public class Root {
    ...
    public static boolean seed(int pluginMajorVersion, String libName) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, MalformedURLException {
